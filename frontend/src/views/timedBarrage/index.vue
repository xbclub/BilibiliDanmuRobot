...
import { Monitor, Restart, Start, Stop } from "../../../wailsjs/go/main/Program";
  ...
  <el-scrollbar class="my-scrollbar">
    <div style="margin: 20px;">
      <el-form :model="data.form" label-width="80px" ref="formRef" class="el-form" :rules="rules">
        ...
        <el-card v-for="(items, index) in data.form.CronDanmuList" style="margin-top: 10px;">
          <template #header>
            <div class="between">
              <span style="color: cornflowerblue;font-size: 20px;margin: 7px 10px 0;font-weight: 700;">
                {{ '弹幕列表' + (index + 1) }}
              </span>
              <el-button class="mt-2" @click="deleteDanmulist(index)" plain type="danger" :icon="Delete" circle>
              </el-button>
            </div>
          </template>
          <div class="between">
            <el-form-item :label="'间隔时间'">
              <el-select v-model="data.form.CronDanmuList[index].Cron" placeholder="Select" size="large">
          ...
          <el-form-item :label="'弹幕' + (index2 + 1)" v-for="(items, index2) in data.form.CronDanmuList[index].Danmu">
            <div class="between">
              ...
              <el-button class="mt-2" @click="deleteDanmu(index, index2)" plain type="danger" :icon="Delete" circle
