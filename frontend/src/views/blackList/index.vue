      ...
      <el-form :model="data.form" label-width="120px" ref="formRef" class="el-form" :rules="rules">
        ...
        <el-form-item v-for="(items, index) in data.form.WelcomeBlacklistWide" :label="'模糊关键词 ' + (index + 1)">
          <div class="between">
            ...
            <el-button class="mt-2" @click="deleteWelcomeBlacklistWide(index)" plain type="danger" :icon="Delete" circle
        ...
        <el-form-item v-for="(items, index) in data.form.WelcomeBlacklist" :label="'精确关键词 ' + (index + 1)">
          <div class="between">
            ...
            <el-button class="mt-2" @click="deleteWelcomeBlacklist(index)" plain type="danger" :icon="Delete" circle
              style="margin-left: 20px;">
            </el-button>
          </div>
        </el-form-item>
